...
extension Task {
    ...
    public init(upon queue: DispatchQueue = Task<SuccessValue>.genericQueue, per flags: DispatchWorkItemFlags = [], onCancel produceError: @autoclosure @escaping() -> Error, body: @escaping() throws -> SuccessValue) {
